...
let secondBook = new Book(' Harry Potter', 'J. Rowling', '2000');
...
let thirdBook = new BookClass (' Harry Potter 3', 'J. ;Rowling', '1997');
let newBook =BookClass.createObjFromCsv('Mes, Hellot');
